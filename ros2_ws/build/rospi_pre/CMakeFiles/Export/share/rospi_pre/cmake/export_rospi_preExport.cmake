...
foreach(_expectedTarget rospi_pre::rospi_pre)
...
# Create imported target rospi_pre::rospi_pre
add_library(rospi_pre::rospi_pre SHARED IMPORTED)
...
file(GLOB CONFIG_FILES "${_DIR}/export_rospi_preExport-*.cmake")
